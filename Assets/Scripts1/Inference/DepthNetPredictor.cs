namespace NatML.Vision {
    ...
    /// </summary>
    public sealed partial class DepthNetPredictor : IMLPredictor<DepthNetPredictor.Matte> {
        ...
        public DepthNetPredictor (MLModel model) => this.model = model as MLEdgeModel;
