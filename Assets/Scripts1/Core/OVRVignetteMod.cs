...
[ExecuteInEditMode]
public class OVRVignetteMod : MonoBehaviour {
	...
	// Get / Set VignetteFieldOfView
    /*
	public float _vignetteFieldOfView
	{
		get { return VignetteFieldOfView; }
		set { VignetteFieldOfView = value; }
	}
    */
    public void ToggleVignette(bool toggle)
    {
        ...
        {
            //Tween the vignette
            DOTween.To(() => VignetteFieldOfView, x => VignetteFieldOfView = x, 60f, 0.2f);
            //VignetteFieldOfView = 60.0f;
        }
        else
        {
            DOTween.To(() => VignetteFieldOfView, x => VignetteFieldOfView = x, 180f, 0.25f);
            //VignetteFieldOfView = 180.0f;
        }
    }
	...
	public float VignetteFieldOfView = 180f;
	...
	private void BuildMaterials()
	{
		...
		if (_OpaqueMaterial == null)
		{
			_OpaqueMaterial = new Material(VignetteShader)
			{
				...
				hideFlags = HideFlags.HideAndDontSave,
				renderQueue = (int)RenderQueue.Overlay //Background
			};
