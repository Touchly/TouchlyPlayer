Shader "Uncharted Limbo/Unlit/MiDaS Depth Visualization Transparent 3"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 uv = lerp(i.uv, float2(i.uv.x, i.uv.y), _SwapChannels);
                ...
                //float stepLimit = (alpha<=_Limit);
                float stepLimit= 1-smoothstep(_Limit-0.1, _Limit+0.1, alpha);
