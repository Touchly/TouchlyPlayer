Shader "Uncharted Limbo/Unlit/MiDaS Depth Visualization Transparent"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                {
                    // Vertex displacement
                    float depth = tex2Dlod(_DepthTex,float4(float2(o.uv.x*0.5,o.uv.y),0,0));
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                else
                {
                    ...
                    float2 uv = lerp(i.uv, float2(i.uv.x*0.5, 1-i.uv.y), _SwapChannels);
